...
Эта инструкция поможет вам сгенерировать конфигурацию Cloudflare WARP для использования с клиентами AmneziaWG и WireGuard, AmneziaVPN, DefaultVPN. Следуйте шагам ниже, чтобы настроить VPN-соединение.
